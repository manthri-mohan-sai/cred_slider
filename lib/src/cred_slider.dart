import 'package:cred_slider/src/thumb.dart';
import 'package:flutter/material.dart';

class CredSlider extends StatefulWidget {
  const CredSlider({
    super.key,
  ...
  @override
  State<CredSlider> createState() => _CredSliderState();
}

class _CredSliderState extends State<CredSlider> {
  ...
  /// The amount of angle which thumb rotates
  double _thumbAngle() {
